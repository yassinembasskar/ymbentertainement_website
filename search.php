<?php
    ...
    if (isset($_POST['search_icon'])) {
        $search_content=$_POST['search_article'];
    }
?>
...
<head>
    ...
    <title>YMB entertainement - <?php echo $search_content;?></title>
...
<body>
        ...
        <div class="left_content container">
            <div class="content hidden container nav_menu" id="nav_menu">
                <ul>
                    ...
                    <a href="categries/movies.php"><li>Movies</li></a>
                    <a href="categries/gaming.php"><li>Gaming</li></a>
                    <a href="categries/tv_shows.php"><li>TV Shows</li></a>
                    <a href="categries/anime.php"><li>Anime</li></a>
                    <a href="categries/music.php"><li>Music</li></a>
                    <?php
                    if ($_SESSION['is_user']) {
    ...
    <section class="main container">
        <section class="main_articles">
            <div class="categorie_title"><h1><?php echo $search_content;?></h1></div>
            <div class="articles_container">
                <?php
                $select = "SELECT * FROM article WHERE title_artcl LIKE '%$search_content%' OR description_artcl LIKE '%$search_content%'";
                ...
                if(mysqli_num_rows($result)>0){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "
                        <a href='categories/".$name_categ."/article".$article_id.".php'>
